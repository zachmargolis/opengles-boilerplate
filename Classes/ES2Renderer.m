...
- (void)loadTexture:(GLuint *)texture forImage:(UIImage *)image;
{
    ...
    void *imageData = calloc(4 * width * height, 1);
    CGContextRef imageContext = CGBitmapContextCreate(imageData, width, height, 8, 4 * width, CGImageGetColorSpace(image.CGImage), kCGImageAlphaPremultipliedLast | kCGBitmapByteOrder32Big);
